...
public class EditorCreateActionComponent : EditorWindow
{
    ...
    public static void CreateActionDialogue()
    {
        ...
        GetWindow<EditorCreateActionComponent>().titleContent.text = "Create Action";
    }
    ...
    void CreateFile(string path)
    {
        ...
        GetWindow<EditorCreateActionComponent>().Close();
